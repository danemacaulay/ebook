...
\section*{Villains}
\addcontentsline{toc}{section}{Villains}

\subsection*{Gangsters and Outlaws}
\addcontentsline{toc}{subsection}{Gangsters and Outlaws}
...
\subsection*{Cult Leaders}
\addcontentsline{toc}{subsection}{Cult Leaders}
...
\subsection*{Dictators}
\addcontentsline{toc}{subsection}{Dictators}
...
\subsection*{Warlords}
\addcontentsline{toc}{subsection}{Warlords}
...
\subsection*{Serial Killers}
\addcontentsline{toc}{subsection}{Serial Killers}
...
\subsection*{Racists}
\addcontentsline{toc}{subsection}{Racists}
...
\section*{Murders, Massacres, and Wars}
\addcontentsline{toc}{section}{Murders, Massacres, and Wars}

\subsection*{Assassinations}
\addcontentsline{toc}{subsection}{Assassinations}
...
\addcontentsline{toc}{subsection}{Executions}
...
\subsection*{Celebrity Murders}
\addcontentsline{toc}{subsection}{Celebrity Murders}
...
\subsection*{School Shootings}
\addcontentsline{toc}{subsection}{School Shootings}
...
\addcontentsline{toc}{subsection}{Terrorist Attacks}
...
\subsection*{Police/Military Killing Civilians}
\addcontentsline{toc}{subsection}{Police/Military Killing Civilians}
...
\subsection*{Revolutions, Coups, and Crusades}
\addcontentsline{toc}{subsection}{Revolutions, Coups, and Crusades}
...
\addcontentsline{toc}{subsection}{World War I}
...
\addcontentsline{toc}{subsection}{World War II}
...
\subsection*{Nukes}
\addcontentsline{toc}{subsection}{Nukes}
...
\subsection*{World War II - Pacific Theatre}
\addcontentsline{toc}{subsection}{World War II - Pacific Theatre}
...
\addcontentsline{toc}{subsection}{Russo-Ukrainian War}
...
\subsection*{Israel–Hamas War}
\addcontentsline{toc}{subsection}{Israel–Hamas War}
...
\subsection*{Child Murders}
\addcontentsline{toc}{subsection}{Child Murders}
...
\subsection*{Familicide}
\addcontentsline{toc}{subsection}{Familicide}
...
\subsection*{Killing Sprees}
\addcontentsline{toc}{subsection}{Killing Sprees}
...
\subsection*{Racist Killings}
\addcontentsline{toc}{subsection}{Racist Killings}
...
\subsection*{Other Murders}
\addcontentsline{toc}{subsection}{Other Murders}
...
\section*{Accidents, Overdoses, and Suicides}
\addcontentsline{toc}{section}{Accidents, Overdoses, and Suicides}

\subsection*{Suicides}
\addcontentsline{toc}{subsection}{Suicides}
...
\subsection*{Excess and Disease}
\addcontentsline{toc}{subsection}{Excess and Disease}
...
\addcontentsline{toc}{subsection}{Accidents}
...
\addcontentsline{toc}{subsection}{Disasters}
...
\addcontentsline{toc}{subsection}{COVID 19 Pandemic }
...
\addcontentsline{toc}{subsection}{COVID 19 Vaccines}
...
\subsection*{Outbreaks and Iatrogenesis}
\addcontentsline{toc}{subsection}{Outbreaks and Iatrogenesis}
...
\section*{Attacks, Abductions and Rapes}
\addcontentsline{toc}{section}{Attacks, Abductions and Rapes}

\subsection*{January 6}
\addcontentsline{toc}{subsection}{January 6}
...
\subsection*{Attacks}
\addcontentsline{toc}{subsection}{Attacks}
...
\subsection*{Abductions and Disappearances}
\addcontentsline{toc}{subsection}{Abductions and Disappearances}
...
\subsection*{Molestations, Rapes, and Trafficking}
\addcontentsline{toc}{subsection}{Molestations, Rapes, and Trafficking}
...
\subsection*{Racially Motivated Attacks}
\addcontentsline{toc}{subsection}{Racially Motivated Attacks}
...
\subsection*{Police Brutality}
\addcontentsline{toc}{subsection}{Police Brutality}
...
\section*{Politics}
\addcontentsline{toc}{section}{Politics}

\subsection*{US Presidents}
\addcontentsline{toc}{subsection}{US Presidents}
...
\insertmydocument{14th Amendment Clause Found to Justify an Infinite Debt
}{poll3.pdf}

\subsection*{US Judiciary}
\addcontentsline{toc}{subsection}{US Judiciary}
...
\subsection*{Other Politicians}
\addcontentsline{toc}{subsection}{Other Politicians}
...
\subsection*{Phoenicians}
\addcontentsline{toc}{subsection}{Phoenicians}
...
\addcontentsline{toc}{subsection}{Aristocracy}
...
\subsection*{ANTIFA}
\addcontentsline{toc}{subsection}{ANTIFA}
...
\subsection*{NASA}
\addcontentsline{toc}{subsection}{NASA}
...
\subsection*{Political Orgs and Activists}
\addcontentsline{toc}{subsection}{Political Orgs and Activists}
...
\subsection*{Political Scandals}
\addcontentsline{toc}{subsection}{Political Scandals}
...
\addcontentsline{toc}{subsection}{Elections}
...
\section*{Relgion}
\addcontentsline{toc}{section}{Relgion}

\subsection*{Leaders}
\addcontentsline{toc}{subsection}{Leaders}
...
\subsection*{Religious Organizations}
\addcontentsline{toc}{subsection}{Religious Organizations}

\insertmydocument{Woody Allen and the Teutonic Knights}{allen.pdf}
\insertmydocument{The Jesuits}{jesuit.pdf}

\subsection*{Occult, New Age, and Self-help}
\addcontentsline{toc}{subsection}{Occult, New Age, and Self-help}
...
\section*{Money}
\addcontentsline{toc}{section}{Money}


\subsection*{Capitalists}
\addcontentsline{toc}{subsection}{Capitalists}
...
\subsection*{Socialists}
\addcontentsline{toc}{subsection}{Socialists}
...
\subsection*{Corporations and Consultants}
\addcontentsline{toc}{subsection}{Corporations and Consultants}
...
\addcontentsline{toc}{subsection}{Economics}
...
\addcontentsline{toc}{section}{Intelligentsia}

\subsection*{Scientists and Inventors}
\addcontentsline{toc}{subsection}{Scientists and Inventors}
...
\subsection*{Psychology and Philosophy}
\addcontentsline{toc}{subsection}{Psychology and Philosophy}
...
\subsection*{Newspapers, Journalists, and Documentarians}
\addcontentsline{toc}{subsection}{Journalists and Documentarians}
...
\addcontentsline{toc}{section}{Alternative Media}

\subsection*{Conspiracy Theorists}
\addcontentsline{toc}{subsection}{Conspiracy Theorists}
...
\subsection*{Pseudoscientists}
\addcontentsline{toc}{subsection}{Pseudoscientists}
...
\addcontentsline{toc}{subsection}{Conspiracy Theories}
...
\section*{The Arts}
\addcontentsline{toc}{section}{The Arts}

\subsection*{Criticism}
\addcontentsline{toc}{subsection}{Criticism}
...
\subsection*{Novelists}
\addcontentsline{toc}{subsection}{Novelists}
...
\subsection*{Playwrights and Poets}
\addcontentsline{toc}{subsection}{Playwrights and Poets}
...
\subsection*{Artists, Patrons, and Critics}
\addcontentsline{toc}{subsection}{Artists, Patrons, and Critics}
...
\addcontentsline{toc}{subsection}{Movements}
...
\subsection*{Art Scandals}
\addcontentsline{toc}{subsection}{Art Scandals}
...
\subsection*{Music Performers}
\addcontentsline{toc}{subsection}{Music Performers}
...
\subsection*{Celebrities and Movie Stars}
\addcontentsline{toc}{subsection}{Celebrities and Movie Stars}
...
\subsection*{Health, Knowledge, Virtue, and the Spirit}
\addcontentsline{toc}{subsection}{Health, Knowledge, Virtue, and the Spirit}
...
\subsection*{Who is Miles Mathis?}
\addcontentsline{toc}{subsection}{Who is Miles Mathis?}
...
\addcontentsline{toc}{subsection}{Sports and Games}
